  ...
  var ROS = function(url) {
    ...
    ros.Topic = function(options) {
      ...
      topic.subscribe = function(callback) {
        ...
        topic.emitterCallback = function(data) {
          var message = new ros.Message(data);
          topic.emit('message', message);
        };
        ros.on(topic.name, topic.emitterCallback);
       ...
       */
      topic.unsubscribe = function(strongUnsub) {
        if (strongUnsub) {
        	...
        	ros.removeListener(topic.name, topic.emitterCallback);
        }
      };
